...
- [Positioning](POSITIONING.md) — what Norma is, what it deliberately isn't, and how it
  compares to adjacent tools.
- [Validation](VALIDATION.md) — live-API validation status per adapter.

Apps & packages overview lives in [ARCHITECTURE.md](ARCHITECTURE.md#packages).
The product site is **norma.team** (`apps/site`).
